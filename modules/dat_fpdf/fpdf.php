...
class PDF_Label extends FPDF {
	...
	var $_Avery_Labels = array(
        ...
        '3669' => array('paper-size'=>'A4',        'metric'=>'mm',    'marginLeft'=>0,        'marginTop'=>21.5,         'NX'=>3,    'NY'=>5,    'SpaceX'=>0,        'SpaceY'=>0,    'width'=>70,        'height'=>50.8,        'font-size'=>9),
        '3490' => array('paper-size'=>'A4',        'metric'=>'mm',    'marginLeft'=>0,        'marginTop'=>45.5,         'NX'=>3,    'NY'=>8,    'SpaceX'=>0,        'SpaceY'=>0,    'width'=>70,        'height'=>36,        'font-size'=>9),
        '4781' => array('paper-size'=>'A4',        'metric'=>'mm',    'marginLeft'=>8,        'marginTop'=>21.6,         'NX'=>2,    'NY'=>6,    'SpaceX'=>0,        'SpaceY'=>0,    'width'=>97,        'height'=>42.3,        'font-size'=>9)
	...
	// Print a label
	function Add_Label($text,$header='',$secondCol='') {
        ...
        //$this->setXY($_PosX-$this->_Padding,$_PosY-$this->_Padding);
        //$this->MultiCell($this->_width,$this->_Height,'',1);
		$this->SetXY($_PosX+3, $_PosY+3);
		
        $header_height=0;
        
		if($header) {
			$this->Set_Font_Size(15);
			$this->setFont('TahomaB');
			$this->multiCell($this->_Width - $this->_Padding,$this->_Line_Height,$header, 0, 'L');
            $header_height=$this->_Line_Height;
        ...
        if($secondCol) {
            $this->setXY($_PosX+3+33,$_PosY+3+$header_height);
            $this->MultiCell($this->_Width - $this->_Padding - 35, $this->_Line_Height, $secondCol, 0, 'L');
        }
	}
